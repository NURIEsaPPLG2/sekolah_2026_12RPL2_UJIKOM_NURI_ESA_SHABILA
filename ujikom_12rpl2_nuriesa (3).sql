...
--
-- Host: localhost:3306
-- Generation Time: Feb 27, 2026 at 03:29 AM
...
(32, '111', 1, 'kelas', 'kuris patah', 'menunggu', '2026-02-26 09:18:49', NULL);
...
--
ALTER TABLE `input_aspirasi`
  MODIFY `id_pelaporan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
ALTER TABLE `input_aspirasi`
  ...
  ADD CONSTRAINT `input_aspirasi_ibfk_4` FOREIGN KEY (`nis`) REFERENCES `user` (`nis`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
